...
import com.hb0730.cloud.admin.server.router.handler.Oauth2AccessDeniedHandler;
import com.hb0730.cloud.admin.server.router.handler.Oauth2ExceptionEntryPoint;
...
public class RouterResourcesConfiguration extends ResourceServerConfigurerAdapter {
    @Resource
