package com.hb0730.cloud.admin.server.user.role.config;

import com.hb0730.cloud.admin.server.user.role.handler.Oauth2AccessDeniedHandler;
import com.hb0730.cloud.admin.server.user.role.handler.Oauth2ExceptionEntryPoint;
...
public class UserRoleResourceConfig extends ResourceServerConfigurerAdapter {
    @Resource
