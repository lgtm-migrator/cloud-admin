package com.hb0730.cloud.admin.gateway.handle;
...
public class JsonSentinelGatewayBlockExceptionHandler implements WebExceptionHandler {
    ...
    private Mono<Void> writeResponse(ServerResponse response, ServerWebExchange exchange) {
        ...
        ResultJson<Object> result = ResponseResult.result(CodeStatusEnum.CURRENT_LIMITING, CodeStatusEnum.CURRENT_LIMITING.getMessage());
        byte[] datas = GsonUtils.json2String(result).getBytes(StandardCharsets.UTF_8);
