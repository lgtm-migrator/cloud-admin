package com.hb0730.cloud.admin.common.web.handler;

import com.hb0730.cloud.admin.common.web.exception.NullPointerException;
import com.hb0730.cloud.admin.common.web.exception.*;
...
public class CloudAdminExceptionHandler {
    ...
    public ResultJson errorHandler(BusinessException exception) {
        String message = String.format("%s", exception.getMessage());
        logger.error(message);
    ...
    @ExceptionHandler(com.hb0730.cloud.admin.common.web.exception.NullPointerException.class)
