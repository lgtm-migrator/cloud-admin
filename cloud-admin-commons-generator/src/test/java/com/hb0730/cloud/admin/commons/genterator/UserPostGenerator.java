...
//        strategy.setEntityBooleanColumnRemoveIsPrefix(true);
        ...
        strategy.setInclude("t_system_user_post");
        //生成 @RestController 控制器
        strategy.setRestControllerStyle(true);
        mpg.setStrategy(strategy);
        //配置包名
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.hb0730.cloud.admin.server.user.post");
        ...
        gc.setOutputDir(projectPath + "/cloud-admin-server-user-post/src/main/java");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/cloud-admin-server-user-post/src/main/resources/mapper/" + pc.getModuleName()
