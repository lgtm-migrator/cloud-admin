...
//        strategy.setEntityBooleanColumnRemoveIsPrefix(true);
        ...
        strategy.setInclude("t_system_permission");
        //生成 @RestController 控制器
        strategy.setRestControllerStyle(true);
        mpg.setStrategy(strategy);
        //配置包名
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.hb0730.cloud.admin.server.permission");
        ...
        gc.setOutputDir(projectPath + "/cloud-admin-server-permission/src/main/java");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/cloud-admin-server-permission/src/main/resources/mapper/" + pc.getModuleName()
