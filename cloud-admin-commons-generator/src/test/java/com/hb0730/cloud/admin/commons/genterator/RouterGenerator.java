...
//        strategy.setEntityBooleanColumnRemoveIsPrefix(true);
        ...
        gc.setOutputDir(projectPath + "/cloud-admin-server-router/src/main/java");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/cloud-admin-server-router/src/main/resources/mapper/" + pc.getModuleName()
